...
class PCGP_Kernel_0(gpytorch.kernels.Kernel):
    def __init__(self, parameter_modifications = {}, number_of_input_dimensions=1, num_tasks=2, **kwargs):
        ...
        self.parameter_dict = {'lengthscale': None, 'amplitude': None}
    ...
    def forward(self, x1, x2, diag=False, **params):
        ...
        def k01_fn(x, y):
            return amplitude*(2*lengthscale*(x[...,0] - y[...,0])*y[...,0] - (lengthscale - (x[...,0] - y[...,0])**2)*(y[...,0]**2 + 1))*torch.exp(-1/2*(x[...,0] - y[...,0])**2/lengthscale)/lengthscale**2
        def k10_fn(x, y):
            return -amplitude*(2*lengthscale*(x[...,0] - y[...,0])*x[...,0] + (lengthscale - (x[...,0] - y[...,0])**2)*(x[...,0]**2 + 1))*torch.exp(-1/2*(x[...,0] - y[...,0])**2/lengthscale)/lengthscale**2
        def k11_fn(x, y):
            return amplitude*(4*lengthscale**2*(lengthscale - (x[...,0] - y[...,0])**2)*x[...,0]*y[...,0] - 2*lengthscale*(3*lengthscale - (x[...,0] - y[...,0])**2)*(x[...,0] - y[...,0])*(x[...,0]**2*y[...,0] - x[...,0]*y[...,0]**2 - x[...,0] + y[...,0]) + (2*lengthscale**2 - 4*lengthscale*(x[...,0] - y[...,0])**2 + (lengthscale - (x[...,0] - y[...,0])**2)**2)*(x[...,0]**2*y[...,0]**2 + x[...,0]**2 + y[...,0]**2 + 1))*torch.exp(-1/2*(x[...,0] - y[...,0])**2/lengthscale)/lengthscale**4
        function_grid = [
            [k00_fn, k01_fn],
            [k10_fn, k11_fn],
        ]
